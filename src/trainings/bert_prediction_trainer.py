...
from src.models.bert_prediction import AnomalyPredictionBertLightning
...
class BertAnomalyPredictionTrainer(PatchTSTTrainer):
    ...
    def setup_model(self, checkpoint_file: Optional[str]) -> Tuple[Path, nn.Module]:
        ...
        if checkpoint_file:
            ...
            model = AnomalyPredictionBertLightning.load_from_checkpoint(
                checkpoint_path,
            ...
            model = AnomalyPredictionBertLightning(
