...
class GraphEncoderBertAnomalyPredictionTrainer(PatchTSTTrainer):
    ...
    def setup_model(self, checkpoint_file: Optional[str]) -> Tuple[Path, nn.Module]:
        ...
        if checkpoint_file:
            ...
            model = GraphEncoderAnomalyPredictionBertLightning.load_from_checkpoint(
                checkpoint_path,
            ...
            model = GraphEncoderAnomalyPredictionBertLightning(
