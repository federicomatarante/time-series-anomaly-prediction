...
from src.models.camsa_bert_prediction import CAMSAAnomalyPredictionBertLightning
...
class CAMSAAnomalyPredictionTrainer(PatchTSTTrainer):
    ...
    def setup_model(self, checkpoint_file: Optional[str]) -> Tuple[Path, nn.Module]:
        ...
        if checkpoint_file:
            ...
            model = CAMSAAnomalyPredictionBertLightning.load_from_checkpoint(
                checkpoint_path,
            ...
            model = CAMSAAnomalyPredictionBertLightning(
